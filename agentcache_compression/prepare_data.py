...
SRC = _REPO / "good_examples" / "vllm_good_examples_raw_2000_search.jsonl"
TRAIN_OUT = _HERE / "data" / "search_agent_train.jsonl"
EVAL_OUT = _HERE / "data" / "search_agent_eval.jsonl"
