        ...
        if not preempted_reqs and self._pause_state == PauseState.UNPAUSED:
            ...
            while (self.waiting or self.skipped_waiting) and token_budget > 0:
                ...
                if request.num_computed_tokens == 0:
                    ...
                    # or async KV-transfer already covers it.  Skipped when
                    # load_kv_async because the connector owns that transfer.
                    # Also skipped for Mamba models (need_mamba_block_aligned_split)
                    # because _mamba_block_aligned_split asserts
                    # num_external_computed_tokens == 0.
                    if not load_kv_async and not self.need_mamba_block_aligned_split:
